    ...
    return (
        <>
            <form className='pt-5 px-5 sm:pt-12 sm:pl-16' onSubmit={onSubmithandler}>
                ...
                <textarea name='description' onChange={onChangeHandler} value={data.description} type="text" className="w-full sm:w-[500px] mt-4 px-4 py-3 border" placeholder='Write here' rows={6} required />
