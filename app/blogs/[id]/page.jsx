    ...
    return (data ? <>
        <div className='bg-gray-200 py-5 px-5 md:px-12 lg:px-28'>
            ...
            <div className='text-center my-24'>
                <h1 className='text-2xl sm:text-5xl font-semibold max-w-[700px] mx-auto'></h1>
                {/* <Image className='mx-auto mt-6 border border-white rounded-full' src={} alt='' width={60} height={60}/> */}
                <p className='mt-1 pb-2 text-lg max-w-[740px] mx-auto'></p>
            </div>
        </div>
        <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
            {/* <Image className='border-4 border-white ' src={} alt='' width={1280} height={720}/> */}
